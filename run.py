...
itinerary = Itinerary(london_sub_graph.graph, 301, 16, A_star())
...
# small_graph = Graph()
# small_graph.add_edge(1, 2, 2, "red")
# small_graph.add_edge(2, 3, 4, "red")
# small_graph.add_edge(3, 4, 2, "red")
# small_graph.add_edge(1, 5, 3, "blue")
# small_graph.add_edge(5, 4, 5, "yellow")
# small_graph.add_edge(1, 6, 1, "green")
# small_graph.add_edge(6, 2, 1, "green")
# it = Itinerary(small_graph, 1, 4, Dijkstra())
# results = it.find_shortest_path()
# print("\nTravel time: " + str(results['travel time']) + "\n" + " -> ".join(results['path']) + "\nStations traversed: " + str(results['stations traversed']))
# results = it.print_itinerary()